...
Feature: Listing tasks
  ...
  Background:
    ...
    And following subtasks exists:
      ...
      | Подзадача 1   | 1         | 0       | 1415812626 | 0            | 
      | Подзадача 2   | 2         | 1       | 1415812566 | 1415812631   | 
    And following notes exists:
      | task_id   | text        | created_at |
      | 1         | Заметка 1   | 1415812566 |
      | 1         | Заметка 2   | 1415812571 |
      | 3         | Заметка 3   | 1415812961 |

  Scenario: list 10 last tasks, where changes are made in subtasks or notes
